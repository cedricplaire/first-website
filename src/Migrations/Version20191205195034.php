 ...
 */
final class Version20191205195034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_message ADD user_id INT NOT NULL, ADD sujet VARCHAR(128) NOT NULL, ADD content LONGTEXT NOT NULL, ADD created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_message DROP user_id, DROP sujet, DROP content, DROP created_at');
    }
}
